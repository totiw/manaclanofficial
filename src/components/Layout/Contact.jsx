    ...
    >
      ...
      <div className="flex flex-col gap-3 lg:gap-10">
        <div className="flex flex-row items-center gap-3 lg:gap-10">
          ...
          <p className="text-white text-[12px] lg:text-3xl font-bold lg:tracking-[5px]">Manaclanid</p>
        </div>
        <div className="flex flex-row items-center gap-3 lg:gap-10">
        ...
        <div className="flex flex-row items-center gap-3 lg:gap-10">
          ...
          <p className="text-white text-[12px] lg:text-3xl font-bold lg:tracking-[5px]">Mana Gaming id</p>
        </div>
        <div className="flex flex-row items-center gap-3 lg:gap-10">
