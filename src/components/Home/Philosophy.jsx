  ...
  return (
    <div className="w-full h-48 lg:h-[683px] relative flex flex-row items-center justify-center px-4 lg:px-[100px] text-center text-white mt-10 mb-20">
      ...
      <div className="flex flex-col items-center gap-5 lg:gap-14">
        <blockquote className="z-30 font-bold text-xl lg:text-4xl select-none lg:tracking-[3px]">
        ...
        <ScrollLink
          ...
          duration={500}
          offset={-80}
          className="z-30 w-24 lg:w-[170px] text-xs lg:text-lg font-bold py-2 lg:py-3 bg-[#4F9AA8] rounded-tr-lg rounded-bl-lg hover:scale-90 duration-300 ease-out transition-all cursor-pointer"
        >
          FIND MORE
        </ScrollLink>
      </div>
