    ...
    >
      ...
      <div className="w-full order-2 lg:order-1 flex flex-col gap-3 lg:gap-20 text-center lg:text-left">
        <div className="flex flex-col lg:flex-row items-center gap-3 lg:gap-8">
          <span className="bg-[#ED6CA9] flex flex-row justify-center items-center w-8 h-8 lg:w-[70px] lg:h-[70px] rounded-full lg:text-4xl font-bold">
            1
          </span>
          <p className="w-80 lg:w-[900px] text-sm lg:text-2xl lg:leading-9 font-bold lg:tracking-[1px]">
      ...
      <h2 className="order-1 lg:order-2 lg:rotate-90 font-bold text-3xl lg:text-7xl lg:tracking-[5px] lg:translate-x-28 mb-4 lg:mb-0 select-none">
        MISSION
      </h2>
    </div>
  );
