  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-5 lg:flex-row lg:justify-between justify-center items-center w-full h-full px-4">
        <h2 className="lg:-rotate-90 font-bold text-3xl lg:text-8xl lg:tracking-[5px] lg:-translate-x-16 select-none">
          VISION
        </h2>
        <blockquote className="font-bold text-center lg:text-left text-sm lg:text-5xl lg:w-[980px] tracking-[2px] leading-4 lg:tracking-[5px] select-none">
