...
const About = () => {
  return (
    <div
      id="about"
      className="relative overflow-hidden lg:overflow-visible flex flex-row w-full lg:h-[1142px] text-white"
    >
      <div className="relative flex flex-col lg:h-full lg:w-full z-[1] p-5 lg:py-14 lg:px-24">
        ...
        <h2 className="relative text-2xl lg:text-5xl text-[#6BCBDD] lg:tracking-[2px] font-bold mb-4 lg:mb-16 select-none">
          About Mana
        </h2>
        <div className="relative lg:h-full flex flex-col gap-4 lg:gap-8 text-xs lg:text-[26px] font-bold">
          <p className="lg:leading-[33.8px] lg:tracking-[2px] select-none">
            MANA is Social Community Where Gamers and ifluencer can gather and socialize to form a solid community and
            forum Force For Good mission is to inspire and empower people. We create uplifting Comumunity that encourage
        ...
        <div className="z-[2] relative flex flex-col gap-6 lg:gap-10">
          <div className="h-2 lg:h-[18px] w-[60%] lg:w-[80%] bg-[#EA0A8C] mt-7"></div>
          <img src={Brand} alt="mana brand" className="w-24 lg:w-[390px] opacity-20" />
        </div>
      </div>
      <img
        src={Poster}
        alt="mana poster"
        className="absolute lg:relative z-0 -translate-y-64 lg:-translate-y-0 lg:right-0 w-full lg:h-full lg:w-auto"
      />
    </div>
  );
};
