  ...
  return (
    ...
    >
      <div className="relative flex flex-col lg:h-full lg:w-full z-[1] p-5 lg:py-14 lg:px-24">
        ...
        <div className="relative lg:h-full flex flex-col gap-4 lg:gap-8 text-xs lg:text-xl font-bold">
          <p className="lg:leading-[33.8px] lg:tracking-[1px] select-none">
        ...
        <div className="z-[2] relative flex flex-col gap-6 lg:gap-10">
          <div className="h-2 lg:h-3 w-[60%] lg:w-[80%] bg-[#EA0A8C] mt-7"></div>
          <img src={Brand} alt="mana brand" className="w-24 lg:w-60 opacity-20" />
        </div>
      </div>
      <img
        src={Poster}
